...
<body class="easyui-layout" style="overflow-y: hidden" fit="true"
	...
	<div region="north" split="true" border="false"
		...
		<span style="float: right; padding-right: 20px;" class="head">欢迎
			${currentLoginUser.name } <a href="#" onclick="showChangePass()">修改密码</a> 
	...
	<div id="w" class="easyui-window" title="修改密码" collapsible="false"
		...
		<div class="easyui-layout" fit="true">
			<div region="center" border="false"
				...
				<form id="form-changepass" action="${contextPath }user/changePassword" method="post">
				<table cellpadding=3>
					<tr>
						<td>原始密码 ：</td>
						<td><input id="oldpassword" name="oldpassword" type="password" class="txt01"/>
							<font color="red">&nbsp;&nbsp;*</font>
						</td>
					</tr>
					<tr>
						<td>修改密码 ：</td>
						<td><input id="newpassword" name="newpassword" type="password" class="txt01" />
							<font color="red">&nbsp;&nbsp;*</font>
						</td>
					</tr>
					<tr>
						<td>确认密码 ：</td>
						<td><input id="confirmpassword" type="password" class="txt01" />
							<font color="red">&nbsp;&nbsp;*</font>
						</td>
					</tr>
				</table>
			...
			<div region="south" border="false"
				...
				<a class="easyui-linkbutton" icon="icon-ok"
					href="javascript:changePass()"> 确定</a> <a
					class="easyui-linkbutton" icon="icon-cancel"
					href="javascript:closeChangePass()">取消</a>
			</div>
		</div>
	</div>
