...
<script type="text/javascript" src="${modulePath}user/home.js"></script>
	    ...
	    <form id="form-query" method="post">
	    	<table cellpadding="5">
	    		<tr>
	    			...
	    			<td>用户名:</td>
	    			<td>
	    				<input class="easyui-textbox" name="username"></input>
	    			</td>
	    		
	    			<td>年龄:</td>
	    			<td>
	    				<input class="easyui-textbox" name="address"></input>
	    			</td>
...
<!-- 	    				<input class="easyui-textbox" type="text" name="keyword"></input> -->
	...
	<thead>
		<tr>
			...
			<th field="name" width="15" halign="center" style="font-weight: bolder;">姓名</th>
			<th field="username" width="15" halign="center">用户</th>
			<th field="age" width="15" halign="center">年龄</th>
			<th field="gender" width="15" halign="center">性别</th>
			<th field="nativePlace" width="15" halign="center">籍贯</th>
			<th field="address" width="20" halign="center">地址</th>
			<th field="phone" width="20" halign="center">手机号码</th>
			<th field="qq" width="20" halign="center">QQ号码</th>
			<th field="wechat" width="20" halign="center">微信号码</th>
		</tr>
	</thead>
</table>
<div id="toolbar">
	<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" title="添加一个用户" onclick="add()">添加</a>
	...
	<form id="form-data" class="easyui-form" method="post" action="#" data-options="novalidate:true">
		<input type="hidden" name="id" id="id"/>
	    	<table cellpadding="5">
	    		<tr>
	    			<td>姓名:</td>
	    			<td><input class="easyui-textbox" name="name"></input></td>
	    		</tr>
	    		<tr>
	    			<td>登陆用户</td>
	    			<td><input class="easyui-textbox" name="username" data-options="required:true,validType:'username'"></input></td>
	    		</tr>
	    		<tr>
	    			<td>登陆密码:</td>
	    		...
	    		<tr>
	    			<td>确认密码:</td>
	    			<td><input class="easyui-textbox" type="password" name="password-v" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>年龄:</td>
	    			<td><input class="easyui-textbox" name="age" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>性别:</td>
	    			<td><input class="easyui-combobox" name="gender" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>祖籍:</td>
	    			<td><input class="easyui-combobox" name="nativePlace" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>居住地:</td>
	    			<td><input class="easyui-textbox" name="address" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>手机号码:</td>
	    			<td><input class="easyui-textbox" name="phone" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>QQ号码:</td>
	    			<td><input class="easyui-textbox" name="qq" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>微信号码:</td>
	    			<td><input class="easyui-textbox" name="whchat" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>电子邮箱:</td>
	    			<td><input class="easyui-textbox" name="mail" data-options="validType:'email'"></input></td>
	    		</tr>
