...
/********************20151231********************/
/*
var val_weeks = ["S","M","T","W","T","F","S"];
var val_months = ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];
*/
var val_weeks = ["日","一","二","三","四","五","六"];
var val_months = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"];
/********************20151231********************/
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:val_weeks,months:val_months,year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
_a4d(this,q);
}},currentText:/*"Today"*/"今 天",closeText:/*"Close"*/"关 闭",okText:/*"Ok"*/"确 定",buttons:[{text:function(_a62){
